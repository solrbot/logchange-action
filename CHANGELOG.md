...
- Remove the "comment-mode" setting. Normal PR comments are now the default and only option. In addition, legacy changelog entry process is improved with code-suggest type of PR comment. No deprecation, sorry. (#111) (Jon Blow, Jane Snow)
